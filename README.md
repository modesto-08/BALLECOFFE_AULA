...
O **BalleCoffe** é uma Landing Page moderna e responsiva desenvolvida com foco em **SEO (Search Engine Optimization)** e boas práticas de Front-end. O projeto simula a página de uma cafeteria fictícia, apresentando produtos, receitas e novidades.
